...
export default defineConfig({
  ...
  build:{chunkSizeWarningLimit:1000,rollupOptions:{input:{main:fileURLToPath(new URL('./index.html',import.meta.url)),cyclist:fileURLToPath(new URL('./cyclist.html',import.meta.url)),movement:fileURLToPath(new URL('./movement.html',import.meta.url))}}}
});
